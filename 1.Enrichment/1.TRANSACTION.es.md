...
| `acquirerIssuerExpectedSettlementDate` | string | Sí | Fecha límite para liquidación en formato RFC 3339 |
| `payOutExpectedSettlementDate` | string | No | Fecha de liquidación en formato RFC 3339 |
