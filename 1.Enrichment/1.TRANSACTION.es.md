...
Este documento describe específicamente el evento `transaction`.
...
```jsonc
{
    ...
    "data": {
        ...
        "paymentPlan": 1, // int
        "transactionType": "credit", // enum: debit | credit | prepaid

        // campos externos
        "externalTransactionIdentifier": "123456789", // TID externo
        "orderNumber": "123456789", // número de pedido externo

        // consejo: igual que enviado por la marca
        "entryMode": "5",
        "electronicCommerceIndicator": "05", // ECI - nunca nulo, usar "" si no está disponible
        ...
        "installments": [
            {
                ...
                "installmentType": "issuer", // enum: issuer | acquirer
                "acquirerIssuerProcessingDate": "2025-01-01T00:00:00.000Z",
                "acquirerIssuerExpectedSettlementDate": "2025-01-01T00:00:00.000Z",
                "payoutExpectedSettlementDate": "2025-01-01T00:00:00.000Z",
        ...
        "vouchers": [
            {
                ...
                "voucherProcessingDate": "2025-01-01T00:00:00.000Z",
                "installmentNumber": 1
            }
        ]
    }
...
| `data.authorizationDate` | string | Sí | Fecha y hora de autorización en formato RFC 3339 |
...
| `data.transactionType` | string | Sí | Tipo de transacción. Valores: "debit", "credit", "prepaid" |
| `data.entryMode` | string | Sí | Modo de entrada de tarjeta (igual que enviado por la marca de tarjeta) |
| `data.electronicCommerceIndicator` | string | No | Indicador de Comercio Electrónico (ECI). Nunca nulo, usar `""` si no está disponible |
| `data.issuer` | object | No | Información del emissor de la tarjeta |
| `data.issuer.code` | string | No | Código del emissor de la tarjeta |
| `data.issuer.name` | string | No | Nombre del emissor de la tarjeta |
...
| `data.externalTransactionIdentifier` | string | No | Identificador de transacción externo (TID) |
| `data.orderNumber` | string | No | Número de pedido externo |
...
| `installmentType` | string | No | Tipo de cuota. Requerido cuando se informan datos de cuotas. Valores: "issuer", "acquirer" |
| `acquirerIssuerProcessingDate` | string | Sí | Fecha de procesamiento del clearing record en formato RFC 3339 |
| `acquirerIssuerExpectedSettlementDate` | string | Sí | Fecha prevista para que el Issuer liquide la transacción al Adquirente, en formato RFC 3339 |
| `payoutExpectedSettlementDate` | string | No | Fecha prevista para que el Adquirente o Subadquirente liquide la transacción a su representado (Merchant o Subadquirente), en formato RFC 3339 |
...
| `voucherProcessingDate` | string | Sí | Fecha de procesamiento del voucher en formato RFC 3339 |
