...
| `acquirerIssuerExpectedSettlementDate` | string | Yes | Settlement deadline in RFC 3339 format |
| `payOutExpectedSettlementDate` | string | No | Actual settlement/payout date in RFC 3339 format |
