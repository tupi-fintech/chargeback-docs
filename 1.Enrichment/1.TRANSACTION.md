...
| `expectedSettlementDate` | string | Yes | Expected settlement date in RFC 3339 format |
| `centralProcessingDate` | string | Yes | Clearing record processing date in RFC 3339 format |
...
| `voucherDate` | string | Yes | Date of the voucher in RFC 3339 format |
