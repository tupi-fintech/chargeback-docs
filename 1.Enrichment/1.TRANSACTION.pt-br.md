...
| `acquirerIssuerExpectedSettlementDate` | string | Sim | Limite para liquidação no formato RFC 3339 |
| `payOutExpectedSettlementDate` | string | Não | Data da liquidação no formato RFC 3339 |
