...
| `expectedSettlementDate` | string | Sim | Data esperada de liquidação no formato RFC 3339 |
| `centralProcessingDate` | string | Sim | Data de envio do clearing record no formato RFC 3339 |
...
| `voucherDate` | string | Sim | Data do voucher no formato RFC 3339 |
