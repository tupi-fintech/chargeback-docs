...
type CycleEvent = {
	...
	payload: {
		...
		recomendation: string, // AI decision recommendation
		requestForInformation: boolean, // email sent to retailer?
		informationReceived: boolean, // received response from retailer?
		startDate: string,
		endDate: string,
	}
}
