...
| `transaction.date`                  | String (RFC 3339)  | Original transaction date and time (UTC)                             | `"2025-01-15T14:30:00Z"`                           |
...
| `chargeback.received_date`          | String (RFC 3339)  | Date and time the chargeback was received (UTC)                      | `"2025-02-20T09:15:00Z"`                           |
